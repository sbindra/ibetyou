...
describe "User pages" do
  ...
  describe "signup" do
    ...
    describe "with valid information" do
      before do
        ...
        fill_in "Facebook",         with: "example_fb"
  ...
  describe "edit" do
    ...
    describe "with valid information" do
      ...
      let(:new_twitter) { "@newnew" }
      let(:new_facebook) { "new_fb" }
      before do
      ...
      specify { user.reload.twittername.should == new_twitter }
      specify { user.reload.facebookname.should == new_facebook }
    end
  end
end